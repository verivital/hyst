...
public class ModelOptions implements GenericOptions
{
	...
	private static final String REACHABILITY_TIME_LABEL = 
			"Reachability Time (0 = no limit)";
	
	private static final String DETECT_MIN_MAX_ERRORS_LABEL = 
			"Attempt to Detect Min/Max Errors (Reduces Performance)";
	
	private static final String PARTIAL_OUTPUT_MS_LABEL = 
			"Partial Output Time (ms)";
	
	private static final String MAX_RECTANGLES_HELP =
			"The maximum number of rectangles to track. This is only enforced before deciding\n" + 
	...
	private static final String TIME_STEP_HELP = 
			"The desired time step per face-lifting operation. This is an estimate, and\n" +
	...
	private static final String DETECT_MIN_MAX_ERRORS_HELP = 
			"Each model needs to have a function which can provide the min/max points\n" +
	...
	private static final String SUCCESSORS_AGGREGATION_HELP =
			"The method to use when computing discrete successors. Doing aggregation may \n" +
	...
	private static final String REACHABILITY_METHOD_HELP =
			"The core reachability method to use. \n" +
	...
	{
		return 
			"If set, this will save the initial states before computing continuous\n" + 
