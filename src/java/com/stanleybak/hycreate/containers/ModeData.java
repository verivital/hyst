...
public class ModeData
{
	...
	public final static String DEFAULT_DERIVATIVE = 
			"return new Interval(0,0); // derivative is constant and zero";
	
	public final static String DEFAULT_MIN_MAX_POINTS = 
			"return null; // derivative has no min/max points in any box";
	
	public final static String DEFAULT_INVARIANT = 
			"return true; // any continuous state is permitted";
	
	public final static String DEFAULT_TIME_TRIGGER = 
			"return null; // not time triggered";
