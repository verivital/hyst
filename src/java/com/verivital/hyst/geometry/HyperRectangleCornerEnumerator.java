...
/**
 * This is a class used for enumerating the corners of a hyperrectangle. you can extend it and override either
 * enumerate or enumerateWithCoord
 * 
 * @author sbak
 *
 */
public class HyperRectangleCornerEnumerator
{
	 ...
	 * @param isMin for each dimension, is p the minimum values for that dimension?
	 */
