...
public class HystFrame extends JFrame implements ActionListener, WindowListener, DocumentListener
{
	...
	// hint text field 
	// from http://stackoverflow.com/questions/1738966/java-jtextfield-with-input-hint
	 ...
	 * @param printer the tool printer that was selected
	 */
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (e.getSource() == printerButton)
		{
			...
			JOptionPane.showMessageDialog(this, text, "Tool Parameter Help",	JOptionPane.INFORMATION_MESSAGE);
		}
	 ...
	 * @param filename the filename that was provided
	 */
