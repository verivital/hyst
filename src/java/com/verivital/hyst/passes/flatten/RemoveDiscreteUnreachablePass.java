...
{	
	...
	protected void runPass(String params)
	{
		...
		for (Iterator<Entry<String, AutomatonMode>> i = ha.modes.entrySet().iterator(); i.hasNext(); )
		{
		...
		for (Iterator <Entry<String, Expression>> i = config.init.entrySet().iterator(); i.hasNext();)
		{
		...
		for (Iterator <Entry<String, Expression>> i = config.forbidden.entrySet().iterator(); i.hasNext();)
		{
			Entry<String, Expression> e = i.next();
