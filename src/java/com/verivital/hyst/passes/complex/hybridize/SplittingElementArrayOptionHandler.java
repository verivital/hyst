	...
	public int parseArguments(Parameters params) throws CmdLineException 
	{
		...
		for (; counter < params.size(); counter++) 
		{
            ...
            for (String partStr : param.split(" ")) 
            {
            	...
            	try
            	{
	            	...
	            	else
	            	{
		            	...
		            	if (ptParts.length != numDims || gradParts.length != numDims)
		            		throw new CmdLineException(owner, "Mismatch in number of dimensions "
		            				+ "(expected " + numDims +") in space trigger: '" + partStr + "'");
		    	...
		    	{
		    		// deprecated: we don't have proper locale support in Hyst
		    		throw new CmdLineException(owner, "Error parsing argument as number: '" + partStr + "'");
		    	}
