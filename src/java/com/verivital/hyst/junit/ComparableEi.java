...
/**
 * This is an ExpressionInterval wrapper used during unit testing. It uses a numerical
 * sampling strategy in order to compare expression intervals
 * 
 * @author Stanley Bak
 *
 */
public class ComparableEi
{
	...
	public boolean equals(Object other)
	{
		...
		if (other instanceof ComparableEi)
		{
			...
			String msg = AutomatonUtil.areExpressionsEqual(a.getExpression(), b.getExpression(), tol);
