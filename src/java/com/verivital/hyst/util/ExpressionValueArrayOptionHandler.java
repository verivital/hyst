...
/**
 * An {@link OptionHandler} for greedily mapping a list of tokens into a collection of {@link Expression}s
 * 
 * This one uses FormulaParser.parseValue to get the expression.
 *
 * This {@code OptionHandler} scans for parameter which begins with <tt>-(NON_NUMBER)</tt>. If found, it will stop.
 * Use parenthesis around expressions that start with -var_name to resolve parsing issues.</p>
 *
 * @author Stanley Bak
 */
public class ExpressionValueArrayOptionHandler extends OptionHandler<Expression> 
{
	public ExpressionValueArrayOptionHandler(CmdLineParser parser, OptionDef option, Setter<Expression> setter) 
	{
