...
{
	/**
	 * Locate an executable by looking through all directories on first an environment variable, and second on  
	 * PATH.
	 * 
	 * This never returns null.
	 * @param programName the executable name to look for. 
	 * @param englishName the name for error / success displays
	 * @param envVarName the name of the environment variable to check before checking PATH
			...
			throws FileNotFoundException
	{
		...
		if (rv == null)
		{
			String text = "The " + englishName + " executable was not found in any of the directories in environment variable " +
