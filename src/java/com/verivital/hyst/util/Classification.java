...
{ 
	 ...
	 * type of automaton
	 * 
	 * HACK: we are also going to use these to classify locations 
	 * for now as well, e.g., a given automaton could have a location 
	 * that has linear dynamics, and another that has nonlinear; we may 
	 * want to use some analysis methods in different locations based on this
	 * 
	 * TODO: this is probably going to be simpler if we use OO features to set up a hierarchy of automaton types,
	 * as e.g., hybrid, nonlinear, nondeterministic is probably the most general class
	 * 
	 * @author tjohnson
	 *
	 * 
