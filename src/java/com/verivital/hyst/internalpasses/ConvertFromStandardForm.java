 ...
 * 
 * This pass converts a hybrid automaton from standard form back to normal. A standard form automaton 
 * is flat, has a single initial state named _init, which is urgent. It has either a single 
 * forbidden state named _error, with no condition on the real variables.
 * 
 * After running the conversion, _init and _error will be deleted, and the configuration's init
 * and forbidden variables will be populated.
 * 
 * @author Stanley Bak
 */
