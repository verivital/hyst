...
public enum Operator 
{
	...
	static final List <Operator> COMPARE_OPS = Arrays.asList(EQUAL, LESS, GREATER, LESSEQUAL, GREATEREQUAL, NOTEQUAL);
	...
	static final List <Operator> COMMUTATIVE_OPS = Arrays.asList(ADD, MULTIPLY, AND, OR, EQUAL, NOTEQUAL);
	...
	{
		throw new RuntimeException("Operators should be printed through ExpressionPrinter.printOperator, never directly.");
	}
