...
public class HystExpressionParser extends Parser
{
	...
	public static final int WS = 1, TICK = 2, TRUE = 3, FALSE = 4, NUM = 5, VAR = 6, LPAR = 7,
			RPAR = 8, LBRAC = 9, RBRAC = 10, COMMA = 11, SEMICOLON = 12, PLUS = 13, MINUS = 14,
			TIMES = 15, DIV = 16, POW = 17, DOT = 18, AND = 19, OR = 20, NOT = 21, LESS = 22,
			GREATER = 23, LESSEQUAL = 24, GREATEREQUAL = 25, NOTEQUAL = 26, EQUAL = 27,
			EQUAL_RESET = 28;
	public static final int RULE_matrixRow = 0, RULE_matrixExpression = 1,
			RULE_functionExpression = 2, RULE_resetSubExpression = 3, RULE_resetExpression = 4,
			RULE_guardExpression = 5, RULE_invariantExpression = 6, RULE_flowExpression = 7,
			RULE_dottedVar = 8, RULE_locExpression = 9, RULE_or = 10, RULE_and = 11, RULE_not = 12,
			RULE_op = 13, RULE_compare = 14, RULE_addSub = 15, RULE_timesDiv = 16, RULE_pow = 17,
			RULE_negativeUnary = 18, RULE_unary = 19;
	public static final String[] ruleNames = { "matrixRow", "matrixExpression",
	...
	private static final String[] _SYMBOLIC_NAMES = { null, "WS", "TICK", "TRUE", "FALSE", "NUM",
			"VAR", "LPAR", "RPAR", "LBRAC", "RBRAC", "COMMA", "SEMICOLON", "PLUS", "MINUS", "TIMES",
			"DIV", "POW", "DOT", "AND", "OR", "NOT", "LESS", "GREATER", "LESSEQUAL", "GREATEREQUAL",
	...
	public static class MatrixContext extends MatrixExpressionContext
	{
		...
		public MatrixContext(MatrixExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitMatrix(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class AndExpressionContext extends AndContext
	{
		...
		{
			return getToken(HystExpressionParser.AND, 0);
		}
	...
	public static class ToNotContext extends AndContext
	{
		...
		public ToNotContext(AndContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitToNot(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3\36\u0102\4\2\t\2"
