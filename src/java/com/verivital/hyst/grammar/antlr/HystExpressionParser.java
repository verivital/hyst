...
public class HystExpressionParser extends Parser
{
	...
	public static final int WS = 1, TICK = 2, TRUE = 3, FALSE = 4, NUM = 5, VAR = 6, LPAR = 7,
			RPAR = 8, LBRAC = 9, RBRAC = 10, COMMA = 11, SEMICOLON = 12, COLON = 13, PLUS = 14,
			MINUS = 15, TIMES = 16, DIV = 17, POW = 18, DOT = 19, AND = 20, OR = 21, NOT = 22,
			LESS = 23, GREATER = 24, LESSEQUAL = 25, GREATEREQUAL = 26, NOTEQUAL = 27, EQUAL = 28,
			EQUAL_RESET = 29;
	public static final int RULE_matrixRow = 0, RULE_matrixRange = 1, RULE_matrixExpression = 2,
			RULE_functionExpression = 3, RULE_resetSubExpression = 4, RULE_resetExpression = 5,
			RULE_guardExpression = 6, RULE_invariantExpression = 7, RULE_flowExpression = 8,
			RULE_dottedVar = 9, RULE_locExpression = 10, RULE_or = 11, RULE_and = 12, RULE_not = 13,
			RULE_op = 14, RULE_compare = 15, RULE_addSub = 16, RULE_timesDiv = 17, RULE_pow = 18,
			RULE_negativeUnary = 19, RULE_unary = 20;
	public static final String[] ruleNames = { "matrixRow", "matrixRange", "matrixExpression",
			"functionExpression", "resetSubExpression", "resetExpression", "guardExpression",
			"invariantExpression", "flowExpression", "dottedVar", "locExpression", "or", "and",
			"not", "op", "compare", "addSub", "timesDiv", "pow", "negativeUnary", "unary" };

	private static final String[] _LITERAL_NAMES = { null, null, "'''", "'true'", "'false'", null,
			null, "'('", "')'", "'['", "']'", "','", "';'", "':'", "'+'", "'-'", "'*'", "'/'",
			"'^'", "'.'", null, null, "'!'", "'<'", "'>'", "'<='", "'>='", "'!='", null, "':='" };
	private static final String[] _SYMBOLIC_NAMES = { null, "WS", "TICK", "TRUE", "FALSE", "NUM",
			"VAR", "LPAR", "RPAR", "LBRAC", "RBRAC", "COMMA", "SEMICOLON", "COLON", "PLUS", "MINUS",
			"TIMES", "DIV", "POW", "DOT", "AND", "OR", "NOT", "LESS", "GREATER", "LESSEQUAL",
			"GREATEREQUAL", "NOTEQUAL", "EQUAL", "EQUAL_RESET" };
	...
	public static class MatrixRowExpContext extends MatrixRowContext
	{
		...
		{
			return getTokens(HystExpressionParser.COMMA);
		}
		...
		public MatrixRowExpContext(MatrixRowContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitMatrixRowExp(this);
			else
	...
	public static class MatrixRangeExpContext extends MatrixRangeContext
	{
		...
		{
			return getTokens(HystExpressionParser.COLON);
		}
		...
		public MatrixRangeExpContext(MatrixRangeContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitMatrixRangeExp(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class MatrixGeneratedContext extends MatrixExpressionContext
	{
		...
		{
			return getToken(HystExpressionParser.LBRAC, 0);
		}
		...
		{
			return getToken(HystExpressionParser.RBRAC, 0);
		}

		public MatrixGeneratedContext(MatrixExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitMatrixGenerated(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class MatrixExplicitContext extends MatrixExpressionContext
	{
		...
		{
			return getTokens(HystExpressionParser.SEMICOLON);
		}
		...
		public MatrixExplicitContext(MatrixExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitMatrixExplicit(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class FunctionContext extends FunctionExpressionContext
	{
		...
		{
			return getToken(HystExpressionParser.VAR, 0);
		}

		public TerminalNode LPAR()
		{
			return getToken(HystExpressionParser.LPAR, 0);
		}

		public TerminalNode RPAR()
		{
			return getToken(HystExpressionParser.RPAR, 0);
		}
		...
		public FunctionContext(FunctionExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitFunction(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public final FunctionExpressionContext functionExpression() throws RecognitionException
	{
		...
		try
		{
			...
			enterOuterAlt(_localctx, 1);
			{
				...
				setState(83);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << NUM) | (1L << VAR)
						| (1L << LPAR) | (1L << LBRAC) | (1L << MINUS))) != 0))
				{
					{
						setState(75);
						addSub(0);
	...
	public static class ResetSubExpressionContext extends ParserRuleContext
	{
		...
		public int getRuleIndex()
		{
			return RULE_resetSubExpression;
		}
	...
	public static class ResetSubEqContext extends ResetSubExpressionContext
	{
		...
		public TerminalNode EQUAL_RESET()
		{
			return getToken(HystExpressionParser.EQUAL_RESET, 0);
		}
		...
		public ResetSubEqContext(ResetSubExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitResetSubEq(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class ResetSubOpContext extends ResetSubExpressionContext
	{
		...
		public ResetSubOpContext(ResetSubExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitResetSubOp(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public final ResetSubExpressionContext resetSubExpression() throws RecognitionException
	{
		...
		try
		{
				...
				enterOuterAlt(_localctx, 2);
			{
				...
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0
						&& ((1L << _la) & ((1L << LESS) | (1L << GREATER) | (1L << LESSEQUAL)
								| (1L << GREATEREQUAL) | (1L << NOTEQUAL) | (1L << EQUAL))) != 0))
				{
					{
						{
							setState(93);
	...
	public static class ResetBlankContext extends ResetExpressionContext
	{
		...
		{
			return getToken(HystExpressionParser.EOF, 0);
		}

		public ResetBlankContext(ResetExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitResetBlank(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class ResetContext extends ResetExpressionContext
	{
		...
		{
			return getTokens(HystExpressionParser.AND);
		}
		...
		public ResetContext(ResetExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitReset(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class GuardBlankContext extends GuardExpressionContext
	{
		...
		public GuardBlankContext(GuardExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitGuardBlank(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class GuardContext extends GuardExpressionContext
	{
		...
		public GuardContext(GuardExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitGuard(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class InvariantExpressionContext extends ParserRuleContext
	{
		...
		public int getRuleIndex()
		{
			return RULE_invariantExpression;
		}
	...
	public static class InvariantContext extends InvariantExpressionContext
	{
		...
		public InvariantContext(InvariantExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitInvariant(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class InvariantBlankContext extends InvariantExpressionContext
	{
		...
		public InvariantBlankContext(InvariantExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitInvariantBlank(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class FlowFalseContext extends FlowExpressionContext
	{
		...
		{
			return getToken(HystExpressionParser.FALSE, 0);
		}

		public FlowFalseContext(FlowExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitFlowFalse(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class FlowBlankContext extends FlowExpressionContext
	{
		...
		public FlowBlankContext(FlowExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitFlowBlank(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class FlowContext extends FlowExpressionContext
	{
		...
		{
			return getTokens(HystExpressionParser.VAR);
		}
		...
		{
			return getTokens(HystExpressionParser.EQUAL);
		}
		...
		{
			return getTokens(HystExpressionParser.TICK);
		}
		...
		public FlowContext(FlowExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitFlow(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class DotVarContext extends DottedVarContext
	{
		...
		{
			return getTokens(HystExpressionParser.DOT);
		}
		...
		{
			return getToken(HystExpressionParser.TICK, 0);
		}

		public DotVarContext(DottedVarContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitDotVar(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class LocExpContext extends LocExpressionContext
	{
		...
		public LocExpContext(LocExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitLocExp(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class LocFalseContext extends LocExpressionContext
	{
		...
		public LocFalseContext(LocExpressionContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitLocFalse(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class OrExpressionContext extends OrContext
	{
		...
		{
			return getToken(HystExpressionParser.OR, 0);
		}
		...
		public OrExpressionContext(OrContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitOrExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class ToAndContext extends OrContext
	{
		...
		public ToAndContext(OrContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitToAnd(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class AndExpressionContext extends AndContext
	{
		...
		public AndExpressionContext(AndContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitAndExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class BoolParenthesesContext extends NotContext
	{
		...
		public BoolParenthesesContext(NotContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitBoolParentheses(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class NotExpressionContext extends NotContext
	{
		...
		{
			return getToken(HystExpressionParser.NOT, 0);
		}
		...
		public NotExpressionContext(NotContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitNotExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class ToCompareContext extends NotContext
	{
		...
		public ToCompareContext(NotContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitToCompare(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class EqualOpContext extends OpContext
	{
		...
		{
			return getToken(HystExpressionParser.EQUAL, 0);
		}

		public EqualOpContext(OpContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitEqualOp(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class GreaterOpContext extends OpContext
	{
		...
		{
			return getToken(HystExpressionParser.GREATER, 0);
		}

		public GreaterOpContext(OpContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitGreaterOp(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class NotEqualOpContext extends OpContext
	{
		...
		{
			return getToken(HystExpressionParser.NOTEQUAL, 0);
		}

		public NotEqualOpContext(OpContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitNotEqualOp(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class GreaterEqualOpContext extends OpContext
	{
		...
		{
			return getToken(HystExpressionParser.GREATEREQUAL, 0);
		}

		public GreaterEqualOpContext(OpContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitGreaterEqualOp(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class LessOpContext extends OpContext
	{
		...
		{
			return getToken(HystExpressionParser.LESS, 0);
		}

		public LessOpContext(OpContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitLessOp(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class LessEqualOpContext extends OpContext
	{
		...
		{
			return getToken(HystExpressionParser.LESSEQUAL, 0);
		}

		public LessEqualOpContext(OpContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitLessEqualOp(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class ConstTrueContext extends CompareContext
	{
		...
		{
			return getToken(HystExpressionParser.TRUE, 0);
		}

		public ConstTrueContext(CompareContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitConstTrue(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class BoolOpContext extends CompareContext
	{
		...
		public BoolOpContext(CompareContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitBoolOp(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class ConstFalseContext extends CompareContext
	{
		...
		public ConstFalseContext(CompareContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitConstFalse(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class PlusContext extends AddSubContext
	{
		...
		{
			return getToken(HystExpressionParser.PLUS, 0);
		}
		...
		public PlusContext(AddSubContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitPlus(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class ToTimesDivContext extends AddSubContext
	{
		...
		public ToTimesDivContext(AddSubContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitToTimesDiv(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class MinusContext extends AddSubContext
	{
		...
		{
			return getToken(HystExpressionParser.MINUS, 0);
		}
		...
		public MinusContext(AddSubContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitMinus(this);
			else
				return visitor.visitChildren(this);
		}
	}
				...
				while (_alt != 2 && _alt != org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER)
				{
					if (_alt == 1)
					{
						...
						_prevctx = _localctx;
						{
							...
							case 1:
							{
								_localctx = new PlusContext(
										new AddSubContext(_parentctx, _parentState));
	...
	public static class MultiplicationContext extends TimesDivContext
	{
		...
		{
			return getToken(HystExpressionParser.TIMES, 0);
		}
		...
		public MultiplicationContext(TimesDivContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitMultiplication(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class DivisionContext extends TimesDivContext
	{
		...
		{
			return getToken(HystExpressionParser.DIV, 0);
		}
		...
		public DivisionContext(TimesDivContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitDivision(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class ToPowContext extends TimesDivContext
	{
		...
		public ToPowContext(TimesDivContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitToPow(this);
			else
				return visitor.visitChildren(this);
		}
	}
						...
						_prevctx = _localctx;
						{
							...
							case 1:
							{
								_localctx = new MultiplicationContext(
										new TimesDivContext(_parentctx, _parentState));
	...
	public static class ToNegativeUnaryContext extends PowContext
	{
		...
		public ToNegativeUnaryContext(PowContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitToNegativeUnary(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class PowExpressionContext extends PowContext
	{
		...
		{
			return getToken(HystExpressionParser.POW, 0);
		}
		...
		public PowExpressionContext(PowContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitPowExpression(this);
			else
				return visitor.visitChildren(this);
		}
	}
			...
			enterOuterAlt(_localctx, 1);
			{
				...
				while (_alt != 2 && _alt != org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER)
				{
					if (_alt == 1)
					{
						...
						{
							{
								_localctx = new PowExpressionContext(
										new PowContext(_parentctx, _parentState));
	...
	public static class ToUnaryContext extends NegativeUnaryContext
	{
		...
		public ToUnaryContext(NegativeUnaryContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitToUnary(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class NegativeContext extends NegativeUnaryContext
	{
		...
		public NegativeContext(NegativeUnaryContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitNegative(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class NumberContext extends UnaryContext
	{
		...
		{
			return getToken(HystExpressionParser.NUM, 0);
		}

		public NumberContext(UnaryContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitNumber(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class DottedVariableContext extends UnaryContext
	{
		...
		public DottedVariableContext(UnaryContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitDottedVariable(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class MatrixExpContext extends UnaryContext
	{
		...
		public MatrixExpContext(UnaryContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitMatrixExp(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class FuncExpContext extends UnaryContext
	{
		...
		public FuncExpContext(UnaryContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitFuncExp(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static class ParenthesesContext extends UnaryContext
	{
		...
		public ParenthesesContext(UnaryContext ctx)
		{
			copyFrom(ctx);
		}
		...
		{
			if (visitor instanceof HystExpressionVisitor)
				return ((HystExpressionVisitor<? extends T>) visitor).visitParentheses(this);
			else
				return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3\37\u0113\4\2\t\2"
