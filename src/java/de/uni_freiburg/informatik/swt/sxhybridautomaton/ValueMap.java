...
/**
 * Maps a VariableParam of the bound Component to a value.
 * The value consists of multiple REAL or INT values matching the number of
 * fields of the VariableParam, as in D1*D2.
 * 
...
public class ValueMap extends BindMap {
	...
	public ValueMap(Bind parent, String key, double... values) {
		super(parent, key);
		for (double value : values) addValue(value);
	}
	
	/**
	 * Use this for REAL Params
	 * @param index 0 is the first value etc.
