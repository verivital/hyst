...
public class SpaceExBaseComponent extends SpaceExComponent 
{
	 ...
	 * @param parent The Document this Component belongs to
	 */
	 ...
	 * @param index Number of the Location, starting at 0
	 * @return The requested Location OR null if the index is out of bounds.
	 */
	public Location getLocation(int index) {
		if ((index < 0) || (index >= mLocations.size())) return null;
	 ...
	 * 		OR null if there is no Location with the wanted ID.
	 */
	 ...
	 * @param id The Location's name.
	 * @return A Location with the given name (there may be several!)
	 * 		OR null if there is no Location with the wanted name.
	 */
	 ...
	 * @param index Number of the Transition, starting at 0
	 ...
	 * @param id The Transition's label.
	 * @return The requested Transition
	 * 		OR null if there is no Transition with the wanted label.
	 */
