...
Converted from file: 
Command Line arguments: -gen nav "-matrix -1.2 0.1 0.2 -1.2 -i_list 4 6 6 6 4 4 A 1 1 4 4 2 1 1 4 3 0 0 B 4 3 0 0 6 6 -width 5 -startx 3.5 -starty 3.5 -noise 0.1" -o nav_fig2b.py -tool pysim "-corners True -legend False -rand 100 -time 20 -title nav_fig2b"
'''
...
def define_ha():
    ...
    mode_1_0.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - 0.0) + 0.1 * (state[3] - 1.0), 0.2 * (state[2] - 0.0) + -1.2 * (state[3] - 1.0)]
    ...
    mode_2_0.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - 0.0) + 0.1 * (state[3] - 1.0), 0.2 * (state[2] - 0.0) + -1.2 * (state[3] - 1.0)]
    ...
    mode_3_0.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - -1.0) + 0.1 * (state[3] - 0.0), 0.2 * (state[2] - -1.0) + -1.2 * (state[3] - 0.0)]
    ...
    mode_4_0.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - -1.0) + 0.1 * (state[3] - 0.0), 0.2 * (state[2] - -1.0) + -1.2 * (state[3] - 0.0)]
    ...
    mode_1_1.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - 0.0) + 0.1 * (state[3] - 1.0), 0.2 * (state[2] - 0.0) + -1.2 * (state[3] - 1.0)]
    ...
    mode_2_1.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - 0.0) + 0.1 * (state[3] - 1.0), 0.2 * (state[2] - 0.0) + -1.2 * (state[3] - 1.0)]
    ...
    mode_4_1.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - 0.0) + 0.1 * (state[3] - -1.0), 0.2 * (state[2] - 0.0) + -1.2 * (state[3] - -1.0)]
    ...
    mode_0_2.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - 0.0) + 0.1 * (state[3] - -1.0), 0.2 * (state[2] - 0.0) + -1.2 * (state[3] - -1.0)]
    ...
    mode_1_2.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - 1.0) + 0.1 * (state[3] - 0.0), 0.2 * (state[2] - 1.0) + -1.2 * (state[3] - 0.0)]
    ...
    mode_4_2.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - 0.0) + 0.1 * (state[3] - -1.0), 0.2 * (state[2] - 0.0) + -1.2 * (state[3] - -1.0)]
    ...
    mode_0_3.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - 0.0) + 0.1 * (state[3] - -1.0), 0.2 * (state[2] - 0.0) + -1.2 * (state[3] - -1.0)]
    ...
    mode_4_3.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - 0.0) + 0.1 * (state[3] - -1.0), 0.2 * (state[2] - 0.0) + -1.2 * (state[3] - -1.0)]
    ...
    mode_0_4.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - 0.0) + 0.1 * (state[3] - -1.0), 0.2 * (state[2] - 0.0) + -1.2 * (state[3] - -1.0)]
    ...
    mode_1_4.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - -1.0) + 0.1 * (state[3] - 0.0), 0.2 * (state[2] - -1.0) + -1.2 * (state[3] - 0.0)]
    ...
    mode_2_4.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - -1.0) + 0.1 * (state[3] - 0.0), 0.2 * (state[2] - -1.0) + -1.2 * (state[3] - 0.0)]
    ...
    mode_3_4.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - -1.0) + 0.1 * (state[3] - 0.0), 0.2 * (state[2] - -1.0) + -1.2 * (state[3] - 0.0)]
    ...
    mode_4_4.der = lambda _, state: [state[2], state[3], -1.2 * (state[2] - 0.0) + 0.1 * (state[3] - -1.0), 0.2 * (state[2] - 0.0) + -1.2 * (state[3] - -1.0)]
...
def plot(result, init_states, image_path, settings):
    ...
    shouldShow = False
    sim.plot_sim_result_multi(result, settings.dim_x, settings.dim_y, image_path, draw_events, legend=False, title='nav_fig2b', show=shouldShow, init_states=init_states)
